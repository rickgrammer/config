...
vim.api.nvim_set_keymap('n', '<leader>bd', ':hide<CR>', opts)
vim.api.nvim_set_keymap('n', '<leader>bfd', ':bd<CR>', opts)
...
vim.api.nvim_set_keymap('n', '<leader>fa', ':lua require\'my-util\'.oil_path_or_default_grep{}<CR>', opts)
vim.api.nvim_set_keymap('n', '<leader>oy', ':lua require\'my-util\'.copy_oil_dir_to_clip{}<CR>', opts)
